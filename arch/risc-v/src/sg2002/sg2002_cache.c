...
void sg2002_inv_dcache_range(uintptr_t start, size_t size) {
	CACHE_OP_RANGE(DCACHE_IPA_A0, start, size);
}

void sg2002_clean_dcache_range(uintptr_t start, size_t size) {
	CACHE_OP_RANGE(DCACHE_CPA_A0, start, size);
}

void sg2002_flush_dcache_range(uintptr_t start, size_t size) {
